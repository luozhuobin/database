...
<html>
<HEAD>
<TITLE>查询系统管理=>修改问题分类</TITLE>
<META http-equiv=Content-Type content="text/html; charset=GB2312">
<meta name=keywords content="查询系统管理=>修改问题分类">
...
<td width="5" height="33" align="left"><img src="images/titleleft.jpg" width="5" height="33"></td>
<td width="10"><img src="images/icon10.jpg" width="3" height="15"></td>
<td><div class="title01">修改问题分类</div></td>
...
?>
<form method="post" name="myform" action="adminclasssave.php?action=edit&classid=<? echo $row['classid'];?>&page=<? echo $page;?>" >
<table width="600" border="1" bordercolor="#dedfe0" align="center" cellpadding="5" cellspacing="0" class="datatable">
  <tr height="28">
   <td class="b1" align="right" width="25%">问题分类名称：</td>
   <td align="left">&nbsp;<INPUT class="inBg2" name="classname"  size="30" value="<? echo $row['classname'];?>"></td>
  </tr>
  <tr height="28">
	<td>&nbsp;</td>
