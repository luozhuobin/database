...
<meta name=keywords content="按产品查看工厂">
...
<td width="5" height="33" align="left"><img src="images/titleleft.jpg" width="5" height="33"></td>
<td width="10"><img src="images/icon10.jpg" width="3" height="15"></td>
<td><div class="title01">按产品查看工厂</div></td>
...
&nbsp;&nbsp;<b>按产品查询</b> <br><?
$i=0;
$rs = mysql_query("select gongchangchanpin from gongchang where gongchangpinpai<>'' group by gongchangchanpin");
while($row = mysql_fetch_array($rs))
{
	$i++;
?>&nbsp;&nbsp;<a href="search_gongchang.php?action=search&sort=gongchangchanpin&key=<? echo $row['gongchangchanpin'];?>"><font color=blue><u><? echo $row['gongchangchanpin'];?></u></font></a>
<?
	if($i>12){ echo '<br>';$i=0;}
