...
<html>
<HEAD>
<TITLE>查询系统管理=>修改品牌编码</TITLE>
<META http-equiv=Content-Type content="text/html; charset=GB2312">
<meta name=keywords content="查询系统管理=>修改品牌编码">
...
<td width="5" height="33" align="left"><img src="images/titleleft.jpg" width="5" height="33"></td>
<td width="10"><img src="images/icon10.jpg" width="3" height="15"></td>
<td><div class="title01">修改品牌编码</div></td>
...
?>
<form method="POST" name="myform" action="adminpinpaiSave.php?action=edit&pinpai_id=<? echo $row['pinpai_id'];?>&page=<? echo $page;?>"  onSubmit="return FormCheck(myform)">
<table width="600" border="1" bordercolor="#dedfe0" align="center" cellpadding="5" cellspacing="0" class="datatable">
  <tr height="28">
   ...
   <td align="left">&nbsp;<INPUT class="inBg2" name="pinpainame"  size="30" value="<? echo $row['pinpainame'];?>"></td>
  </tr>
  <tr height="28">
...
<?	}mysql_free_result($rs2);?>	
  ...
  <tr height="28">
   ...
   <td align="left">&nbsp;<INPUT class="inBg2" name="pinpaicode"  size="30" value="<? echo $row['pinpaicode'];?>"></td>
  </tr>
  <tr height="28">
   <td class="b1" align="right">品牌地址：</td>
   <td align="left">&nbsp;<INPUT class="inBg2" name="pinpaidizhi"  size="30" value="<? echo $row['pinpaidizhi'];?>"></td>
  </tr>
  <tr height="28">
   <td class="b1" align="right">联系电话：</td>
   <td align="left">&nbsp;<INPUT class="inBg2" name="pinpaidianhua"  size="30" value="<? echo $row['pinpaidianhua'];?>"></td>
  </tr>
  <tr height="28">
