...
<html>
<HEAD>
<TITLE>查询系统管理=>修改热线电话</TITLE>
<META http-equiv=Content-Type content="text/html; charset=GB2312">
<meta name=keywords content="查询系统管理=>修改热线电话">
...
<td width="5" height="33" align="left"><img src="images/titleleft.jpg" width="5" height="33"></td>
<td width="10"><img src="images/icon10.jpg" width="3" height="15"></td>
<td><div class="title01">修改热线电话</div></td>
...
?>
<form method="post" name="myform" action="adminphonesave.php?action=edit&phoneid=<? echo $row['phoneid'];?>&page=<? echo $page;?>">
<table width="600" border="1" bordercolor="#dedfe0" align="center" cellpadding="5" cellspacing="0" class="datatable">
  <tr height="28">
   ...
   <td align="left">&nbsp;<INPUT class="inBg2" name="city"  size="30" value="<? echo $row['city'];?>">(格式要求：如广州市请直接填写<font color=red>广州</font>)</td>
  </tr>
  <tr height="28">
   <td class="b1" align="right">单位名称：</td>
   <td align="left">&nbsp;<INPUT class="inBg2" name="institution"  size="30" value="<? echo $row['institution'];?>"></td>
  </tr>
  <tr height="28">
   <td class="b1" align="right">联系电话：</td>
   <td align="left">&nbsp;<INPUT class="inBg2" name="phone"  size="30" value="<? echo $row['phone'];?>">
	</td>
  </tr>
  <tr height="28">
   <td class="b1" align="right">单位地址：</td>
   <td align="left">&nbsp;<INPUT class="inBg2" name="address"  size="30" value="<? echo $row['address'];?>"></td>
  </tr>
  <tr height="28">
	<td>&nbsp;</td>
