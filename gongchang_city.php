...
<html>
<head>
<TITLE>按所属城市查看工厂</TITLE>
<META http-equiv=Content-Type content="text/html; charset=GB2312">
<meta name=keywords content="按所属城市查看工厂">
...
<tr>
<td width="5">&nbsp;</td>
<td width="201" valign="top" style="background:url(images/leftbottom.jpg) no-repeat bottom left; padding-bottom:137px; width:201px;border-left:1px #cccccc;background-color:#F7F7F7;border-left:1px #decfbf solid;border-right:1px #decfbf solid; ">
...
<td width="5" height="33" align="left"><img src="images/titleleft.jpg" width="5" height="33"></td>
<td width="10"><img src="images/icon10.jpg" width="3" height="15"></td>
<td><div class="title01">按所属城市查看工厂</div></td>
...
if($_SESSION['kind']==2){
	$sql="select cityname from gongchang where gongchangpinpai='$pinpaicode' and cityname<>'' group by cityname";
}else{
	$sql="select cityname from city where cityname<>'' order by cityname asc";
}
$rs = mysql_query($sql);
while($row = mysql_fetch_array($rs))
{
	$i++;?>
&nbsp;&nbsp;<a href="search_gongchang.php?action=search&sort=cityname&key=<? echo $row['cityname'];?>"><font color=blue><u><? echo $row['cityname'];?></u></font></a>
<?
	if($i>12){ echo '<br>';$i=0;}
