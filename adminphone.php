...
<html>
<HEAD>
<TITLE>查询系统管理=>电话管理</TITLE>
<META http-equiv=Content-Type content="text/html; charset=GB2312">
<meta name=keywords content="查询系统管理=>电话管理">
...
<td width="5" height="33" align="left"><img src="images/titleleft.jpg" width="5" height="33"></td>
<td width="10"><img src="images/icon10.jpg" width="3" height="15"></td>
<td><div class="title01">电话管理</div></td>
...
<a href="addphone.php">添加新电话</a>
<br><br>
全国劳动保障热线   12333
<br><br>
<table width="750" border="1" bordercolor="#dedfe0" align="center" cellpadding="0" cellspacing="0" class="datatable">
  <tr height="30" align="center">
   <td class="b1 titsty">城市</td>
   <td class="b1 titsty">单位名称</td>
   <td class="b1 titsty">单位电话</td>
   <td class="b1 titsty">单位地址</td>
...
?>
  <tr height="28" align="center">
   ...
   <td><a href="editphone.php?phoneid=<? echo $row['phoneid'];?>&page=<? echo $fenyeObj->page;?>">修改</a>&nbsp;&nbsp;<a href="adminphonesave.php?action=del&phoneid=<? echo $row['phoneid'];?>&page=<? echo $fenyeObj->page;?>" onClick="if(confirm('确定删除吗?')==false){ return false;}">删除</a></td>
  </tr>
<?
