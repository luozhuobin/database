...
<html>
<HEAD>
<TITLE>查询系统管理=>添加新问题分类</TITLE>
<META http-equiv=Content-Type content="text/html; charset=GB2312">
<meta name=keywords content="查询系统管理=>添加新问题分类">
...
<td width="5" height="33" align="left"><img src="images/titleleft.jpg" width="5" height="33"></td>
<td width="10"><img src="images/icon10.jpg" width="3" height="15"></td>
<td><div class="title01">添加新问题分类</div></td>
...
<form method="post" name="myform" action="adminclasssave.php?action=add">
<table width="600" border="1" bordercolor="#dedfe0" align="center" cellpadding="5" cellspacing="0" class="datatable">
  <tr height="28">
   ...
   <td align="left">&nbsp;<INPUT type="text" class="inBg2" name="classname" size="30" value=""></td>
  </tr>
