...
<html>
<head>
<TITLE>查询系统管理=>品牌编码管理</TITLE>
<META http-equiv=Content-Type content="text/html; charset=GB2312">
<meta name=keywords content="查询系统管理=>品牌编码管理">
...
<td width="5" height="33" align="left"><img src="images/titleleft.jpg" width="5" height="33"></td>
<td width="10"><img src="images/icon10.jpg" width="3" height="15"></td>
<td><div class="title01">品牌编码管理</div></td>
...
<a href="addpinpai.php">添加新品牌编码</a>
<br><br>
<table width="700" border="1" bordercolor="#dedfe0" align="center" cellpadding="0" cellspacing="0" class="datatable">
  <tr height="30" align="center">
   <td class="b1 titsty">品牌名称</td>
   <td class="b1 titsty">所在城市</td>
   <td class="b1 titsty">品牌编码</td>
   <td class="b1 titsty" width="25%">操作</td>
  </tr><?
...
if($row[0] > 0)
{
	...
	$rs = mysql_query("select pinpai_id,pinpainame,pinpaicode,cityname from pinpai order by pinpai_id desc limit ".($fenyeObj->page-1)*$pageSize.','.$pageSize."");
...
?>
  <tr height="28" align="center" bgcolor="#fafafa">
   ...
   <td><a href="pinpai.php?pinpai_id=<? echo $row['pinpai_id'];?>&page=<? echo $fenyeObj->page;?>" target="_blank">查看</a>&nbsp;&nbsp;<a href="editpinpai.php?pinpai_id=<? echo $row['pinpai_id'];?>&page=<? echo $fenyeObj->page;?>">修改</a>&nbsp;&nbsp;<a href="adminpinpaiSave.php?action=del&pinpai_id=<? echo $row['pinpai_id'];?>&page=<? echo $fenyeObj->page;?>" onClick="if(confirm('确定删除吗?')==false){ return false;}">删除</a></td>
  </tr>
<?
