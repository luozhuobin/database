...
<html>
<HEAD>
<TITLE>查询系统管理=>添加新映诺脚本</TITLE>
<META http-equiv=Content-Type content="text/html; charset=GB2312">
<meta name=keywords content="查询系统管理=>添加新映诺脚本">
...
<td width="5" height="33" align="left"><img src="images/titleleft.jpg" width="5" height="33"></td>
<td width="10"><img src="images/icon10.jpg" width="3" height="15"></td>
<td><div class="title01">添加新映诺脚本</div></td>
...
<table width="800" border="1" bordercolor="#dedfe0" align="center" cellpadding="5" cellspacing="0" class="datatable">
  ...
  <tr height="28">
   ...
   <td align="left">&nbsp;<select name="leixing">
        <option  value=0  >工作准备</option>
        <option  value=1  >电话脚本</option>
        <option  value=2  >沟通问题</option>
        <option  value=3  >咨询映诺</option>
        <option  value=4  >申诉咨询</option>
        <option  value=5  >心理适用</option>
        <option  value=6  >求助映诺</option>
    </select>
	</td>
  </tr>
