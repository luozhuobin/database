...
<html>
<HEAD>
<TITLE>查询系统管理=>问题分类管理</TITLE>
<META http-equiv=Content-Type content="text/html; charset=GB2312">
<meta name=keywords content="查询系统管理=>问题分类管理">
...
<td width="5" height="33" align="left"><img src="images/titleleft.jpg" width="5" height="33"></td>
<td width="10"><img src="images/icon10.jpg" width="3" height="15"></td>
<td><div class="title01">问题分类管理</div></td>
...
<a href="addclass.php">添加新问题分类</a>
<br><br>
<table width="600" border="1" bordercolor="#dedfe0" align="center" cellpadding="0" cellspacing="0" class="datatable">
  <tr height="30" align="center">
   <td class="b1 titsty">分类序号</td>
   <td class="b1 titsty">分类名称</td>
   <td class="b1 titsty">数量统计</td>
   <td class="b1 titsty">操作</td>
  </tr><?
$rs = mysql_query("select count(classid) from class");
...
if($row[0] > 0)
{
	...
	$rs = mysql_query("select * from class order by classid desc limit ".($fenyeObj->page-1)*$pageSize.','.$pageSize."");
	while($row = mysql_fetch_array($rs,MYSQL_ASSOC))
	{	
?>
  <tr height="28" align="center" bgcolor="#fafafa">
   <td ><? echo $row['classid'];?></td>
   <td ><? echo $row['classname'];?></td>
   <td ><? echo $row['count'];?></td>
   <td ><a href="editclass.php?classid=<? echo $row['classid'];?>&page=<? echo $fenyeObj->page;?>">修改</a></td>
  </tr>
<?
